...
// pb_hooks/videovsr.pb.js — RunningHub AI 应用中转模板
//
...
routerAdd("GET", "/api/aigc/ai-app/videovsr/schema", function (e) {
  // SAFE_SCHEMA 只含前端渲染表单需要的安全字段, 由 install_ai_app 从 manifest 注入。
  // 绝不含 nodeId / fieldName / webappId / RunningHub 端点。
  var SAFE_SCHEMA = {"version": "rh-ai-app.v1", "slug": "videovsr", "model": "ai-app-videovsr", "title": "视频高清修复", "intent": "video-upscale", "fields": [{"key": "referenceVideo", "label": "上传视频", "type": "video", "required": false, "group": "basic", "defaultValue": "cbdd6e22fed5f2c302f3b05f7f061572b546c601a50a32b48fd4fe11f7ccbdc6.mp4", "description": "上传视频"}, {"key": "node108_select", "label": "模型切换", "type": "select", "required": false, "group": "basic", "defaultValue": "1", "options": [{"label": "input2", "value": "2", "description": "FlashVSR"}, {"label": "input1", "value": "1", "description": "SeedVR2"}], "description": "模型切换"}, {"key": "node112_value", "label": "最大分辨率（不建议超过1920）", "type": "number", "required": false, "group": "advanced", "defaultValue": "1920", "description": "最大分辨率（不建议超过1920）"}], "outputs": {"expectedTypes": ["video"], "render": "player"}}

  return e.json(200, SAFE_SCHEMA)
})

routerAdd("POST", "/api/aigc/ai-app/videovsr/upload", function (e) {
  function readKey(ev) {
...
routerAdd("POST", "/api/aigc/ai-app/videovsr/run", function (e) {
  var VIBEX_APP_ID = "app-ca81449e917d4660aa213c5c13d47008"
  var WEBAPP_ID = "2064116518987845634"
  var MODEL = "ai-app-videovsr"
  var NODE_INFO_TEMPLATE = [{"nodeId": "46", "fieldName": "video", "fieldValue": "cbdd6e22fed5f2c302f3b05f7f061572b546c601a50a32b48fd4fe11f7ccbdc6.mp4"}, {"nodeId": "108", "fieldName": "select", "fieldValue": "1"}, {"nodeId": "112", "fieldName": "value", "fieldValue": "1920"}]
  ...
  function buildNodeInfoList(body) {
    ...
    var __v0 = (body["referenceVideo"] === undefined || body["referenceVideo"] === null) ? "cbdd6e22fed5f2c302f3b05f7f061572b546c601a50a32b48fd4fe11f7ccbdc6.mp4" : body["referenceVideo"]
    setNodeValue(nodes, "46", "video", (__v0 === undefined || __v0 === null) ? "" : String(__v0))
    var __v1 = (body["node108_select"] === undefined || body["node108_select"] === null) ? "1" : body["node108_select"]
    setNodeValue(nodes, "108", "select", (__v1 === undefined || __v1 === null) ? "" : String(__v1))
    var __v2 = (body["node112_value"] === undefined || body["node112_value"] === null) ? "1920" : body["node112_value"]
    setNodeValue(nodes, "112", "value", (__v2 === undefined || __v2 === null) ? "" : String(__v2))
    return nodes
  }
...
routerAdd("POST", "/api/aigc/ai-app/videovsr/price-preview", function (e) {
  var WEBAPP_ID = "2064116518987845634"
  var NODE_INFO_TEMPLATE = [{"nodeId": "46", "fieldName": "video", "fieldValue": "cbdd6e22fed5f2c302f3b05f7f061572b546c601a50a32b48fd4fe11f7ccbdc6.mp4"}, {"nodeId": "108", "fieldName": "select", "fieldValue": "1"}, {"nodeId": "112", "fieldName": "value", "fieldValue": "1920"}]
...
routerAdd("POST", "/api/aigc/ai-app/videovsr/jobs/{jobId}/poll", function (e) {
  var MODEL = "ai-app-videovsr"
...
routerAdd("POST", "/api/aigc/ai-app/videovsr/history", function (e) {
  var MODEL = "ai-app-videovsr"
...
routerAdd("POST", "/api/aigc/ai-app/videovsr/history/{jobId}/update", function (e) {
  var MODEL = "ai-app-videovsr"
...
routerAdd("POST", "/api/aigc/ai-app/videovsr/history/{jobId}/delete", function (e) {
  var MODEL = "ai-app-videovsr"
