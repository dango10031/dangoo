...
// pb_hooks/wan22hq.pb.js — RunningHub AI 应用中转模板
//
...
routerAdd("GET", "/api/aigc/ai-app/wan22hq/schema", function (e) {
  // SAFE_SCHEMA 只含前端渲染表单需要的安全字段, 由 install_ai_app 从 manifest 注入。
  // 绝不含 nodeId / fieldName / webappId / RunningHub 端点。
  var SAFE_SCHEMA = {"version": "rh-ai-app.v1", "slug": "wan22hq", "model": "ai-app-wan22hq", "title": "WAN 2.2 图生视频 6 秒高质量", "intent": "image-to-video", "fields": [{"key": "node438_value", "label": "最长分辨率", "type": "number", "required": false, "group": "advanced", "defaultValue": "1280", "description": "最长分辨率"}, {"key": "node446_value", "label": "总帧数", "type": "number", "required": false, "group": "basic", "defaultValue": "81", "description": "总帧数"}, {"key": "referenceImage", "label": "图像上传", "type": "image", "required": false, "group": "basic", "defaultValue": "4226b9fe259a040e69a4891e586de460c0bf7608548a54a4682d3e40b68ccdb0.jpg", "description": "图像上传"}, {"key": "text", "label": "提示词", "type": "textarea", "required": false, "group": "basic", "defaultValue": "手持镜头拍摄，女孩看着远方发呆，偶尔缓慢的眨了眨眼睛。", "description": "提示词"}], "outputs": {"expectedTypes": ["image"], "render": "gallery"}}

  return e.json(200, SAFE_SCHEMA)
})

routerAdd("POST", "/api/aigc/ai-app/wan22hq/upload", function (e) {
  function readKey(ev) {
...
routerAdd("POST", "/api/aigc/ai-app/wan22hq/run", function (e) {
  var VIBEX_APP_ID = "app-ca81449e917d4660aa213c5c13d47008"
  var WEBAPP_ID = "2049858355920941057"
  var MODEL = "ai-app-wan22hq"
  var NODE_INFO_TEMPLATE = [{"nodeId": "438", "fieldName": "value", "fieldValue": "1280"}, {"nodeId": "446", "fieldName": "value", "fieldValue": "81"}, {"nodeId": "78", "fieldName": "image", "fieldValue": "4226b9fe259a040e69a4891e586de460c0bf7608548a54a4682d3e40b68ccdb0.jpg"}, {"nodeId": "422", "fieldName": "text", "fieldValue": "手持镜头拍摄，女孩看着远方发呆，偶尔缓慢的眨了眨眼睛。"}]
  ...
  function buildNodeInfoList(body) {
    ...
    var __v0 = (body["node438_value"] === undefined || body["node438_value"] === null) ? "1280" : body["node438_value"]
    setNodeValue(nodes, "438", "value", (__v0 === undefined || __v0 === null) ? "" : String(__v0))
    var __v1 = (body["node446_value"] === undefined || body["node446_value"] === null) ? "81" : body["node446_value"]
    setNodeValue(nodes, "446", "value", (__v1 === undefined || __v1 === null) ? "" : String(__v1))
    var __v2 = (body["referenceImage"] === undefined || body["referenceImage"] === null) ? "4226b9fe259a040e69a4891e586de460c0bf7608548a54a4682d3e40b68ccdb0.jpg" : body["referenceImage"]
    setNodeValue(nodes, "78", "image", (__v2 === undefined || __v2 === null) ? "" : String(__v2))
    var __v3 = (body["text"] === undefined || body["text"] === null) ? "手持镜头拍摄，女孩看着远方发呆，偶尔缓慢的眨了眨眼睛。" : body["text"]
    setNodeValue(nodes, "422", "text", (__v3 === undefined || __v3 === null) ? "" : String(__v3))
    return nodes
  }
...
routerAdd("POST", "/api/aigc/ai-app/wan22hq/price-preview", function (e) {
  var WEBAPP_ID = "2049858355920941057"
  var NODE_INFO_TEMPLATE = [{"nodeId": "438", "fieldName": "value", "fieldValue": "1280"}, {"nodeId": "446", "fieldName": "value", "fieldValue": "81"}, {"nodeId": "78", "fieldName": "image", "fieldValue": "4226b9fe259a040e69a4891e586de460c0bf7608548a54a4682d3e40b68ccdb0.jpg"}, {"nodeId": "422", "fieldName": "text", "fieldValue": "手持镜头拍摄，女孩看着远方发呆，偶尔缓慢的眨了眨眼睛。"}]
...
routerAdd("POST", "/api/aigc/ai-app/wan22hq/jobs/{jobId}/poll", function (e) {
  var MODEL = "ai-app-wan22hq"
...
routerAdd("POST", "/api/aigc/ai-app/wan22hq/history", function (e) {
  var MODEL = "ai-app-wan22hq"
...
routerAdd("POST", "/api/aigc/ai-app/wan22hq/history/{jobId}/update", function (e) {
  var MODEL = "ai-app-wan22hq"
...
routerAdd("POST", "/api/aigc/ai-app/wan22hq/history/{jobId}/delete", function (e) {
  var MODEL = "ai-app-wan22hq"
