...
// pb_hooks/animatev9.pb.js — RunningHub AI 应用中转模板
//
...
routerAdd("GET", "/api/aigc/ai-app/animatev9/schema", function (e) {
  // SAFE_SCHEMA 只含前端渲染表单需要的安全字段, 由 install_ai_app 从 manifest 注入。
  // 绝不含 nodeId / fieldName / webappId / RunningHub 端点。
  var SAFE_SCHEMA = {"version": "rh-ai-app.v1", "slug": "animatev9", "model": "ai-app-animatev9", "title": "Animate 动作迁移 V9", "intent": "video-to-video", "fields": [{"key": "trueFalse", "label": "True 正常模式|| False 防突变长视频会劣化", "type": "boolean", "required": false, "group": "basic", "defaultValue": "true", "description": "True 正常模式|| False 防突变长视频会劣化"}, {"key": "node571_select", "label": "输出方式", "type": "select", "required": false, "group": "basic", "defaultValue": "1", "options": [{"label": "input1", "value": "1", "description": "正常输出"}, {"label": "input2", "value": "2", "description": "ZIP输出"}], "description": "输出方式"}, {"key": "node563_select", "label": "姿势选择", "type": "select", "required": false, "group": "advanced", "defaultValue": "1", "options": [{"label": "input3", "value": "3", "description": "WUWUPOSE"}, {"label": "input2", "value": "2", "description": "SDPOSE"}, {"label": "input1", "value": "1", "description": "VITPOSE"}], "description": "姿势选择"}, {"key": "node497_value", "label": "姿势3,若脖子长开启（正常关闭）", "type": "boolean", "required": false, "group": "advanced", "defaultValue": "false", "description": "姿势3,若脖子长开启（正常关闭）"}, {"key": "node297_value", "label": "姿势强度", "type": "number", "required": false, "group": "advanced", "defaultValue": "1.0000000000000002", "description": "姿势强度"}, {"key": "node370_value", "label": "运镜开关（默认为关闭）", "type": "boolean", "required": false, "group": "advanced", "defaultValue": "false", "description": "运镜开关（默认为关闭）"}, {"key": "node361_value", "label": "运镜强度", "type": "number", "required": false, "group": "advanced", "defaultValue": "1.0000000000000002", "description": "运镜强度"}, {"key": "node271_value", "label": "面具头盔模式", "type": "boolean", "required": false, "group": "advanced", "defaultValue": "false", "description": "面具头盔模式"}, {"key": "node265_value", "label": "表情强度", "type": "number", "required": false, "group": "advanced", "defaultValue": "0.8000000000000002", "description": "表情强度"}, {"key": "node266_value", "label": "胸部抖动幅度", "type": "number", "required": false, "group": "advanced", "defaultValue": "0.20000000000000004", "description": "胸部抖动幅度"}, {"key": "node499_value", "label": "跳过前面多少帧", "type": "number", "required": false, "group": "advanced", "defaultValue": "0", "description": "跳过前面多少帧"}, {"key": "node422_value", "label": "加载帧上限", "type": "number", "required": false, "group": "advanced", "defaultValue": "840", "description": "加载帧上限"}, {"key": "node264_value", "label": "帧率", "type": "number", "required": false, "group": "advanced", "defaultValue": "30", "description": "帧率"}, {"key": "node566_select", "label": "分辨率", "type": "select", "required": false, "group": "advanced", "defaultValue": "2", "options": [{"label": "input3", "value": "3", "description": "1080P 最多10秒"}, {"label": "input2", "value": "2", "description": "720P "}, {"label": "input1", "value": "1", "description": "480P"}], "description": "分辨率"}, {"key": "node452_value", "label": "开启自定义比例", "type": "boolean", "required": false, "group": "advanced", "defaultValue": "false", "description": "开启自定义比例"}, {"key": "node451_value", "label": "自定义比例宽", "type": "number", "required": false, "group": "advanced", "defaultValue": "9", "description": "自定义比例宽"}, {"key": "node450_value", "label": "自定义比例高", "type": "number", "required": false, "group": "advanced", "defaultValue": "16", "description": "自定义比例高"}, {"key": "referenceImage", "label": "加载参考图片", "type": "image", "required": false, "group": "basic", "defaultValue": "c3cef5cfb224f01d4ca4dce74217bbe78ca8d36963b49292edec293d92343d7a.png", "description": "加载参考图片"}, {"key": "referenceVideo", "label": "video", "type": "video", "required": false, "group": "basic", "defaultValue": "3767ba75a93db673b017f1f2735e7ea586b72242e6a98495350213d15f7cb804.mp4", "description": "video"}], "outputs": {"expectedTypes": ["video"], "render": "player"}}

  return e.json(200, SAFE_SCHEMA)
})

routerAdd("POST", "/api/aigc/ai-app/animatev9/upload", function (e) {
  function readKey(ev) {
...
routerAdd("POST", "/api/aigc/ai-app/animatev9/run", function (e) {
  var VIBEX_APP_ID = "app-ca81449e917d4660aa213c5c13d47008"
  var WEBAPP_ID = "1975951975441412098"
  var MODEL = "ai-app-animatev9"
  var NODE_INFO_TEMPLATE = [{"nodeId": "538", "fieldName": "value", "fieldValue": "true"}, {"nodeId": "571", "fieldName": "select", "fieldValue": "1"}, {"nodeId": "563", "fieldName": "select", "fieldValue": "1"}, {"nodeId": "497", "fieldName": "value", "fieldValue": "false"}, {"nodeId": "297", "fieldName": "value", "fieldValue": "1.0000000000000002"}, {"nodeId": "370", "fieldName": "value", "fieldValue": "false"}, {"nodeId": "361", "fieldName": "value", "fieldValue": "1.0000000000000002"}, {"nodeId": "271", "fieldName": "value", "fieldValue": "false"}, {"nodeId": "265", "fieldName": "value", "fieldValue": "0.8000000000000002"}, {"nodeId": "266", "fieldName": "value", "fieldValue": "0.20000000000000004"}, {"nodeId": "499", "fieldName": "value", "fieldValue": "0"}, {"nodeId": "422", "fieldName": "value", "fieldValue": "840"}, {"nodeId": "264", "fieldName": "value", "fieldValue": "30"}, {"nodeId": "566", "fieldName": "select", "fieldValue": "2"}, {"nodeId": "452", "fieldName": "value", "fieldValue": "false"}, {"nodeId": "451", "fieldName": "value", "fieldValue": "9"}, {"nodeId": "450", "fieldName": "value", "fieldValue": "16"}, {"nodeId": "299", "fieldName": "image", "fieldValue": "c3cef5cfb224f01d4ca4dce74217bbe78ca8d36963b49292edec293d92343d7a.png"}, {"nodeId": "574", "fieldName": "video", "fieldValue": "3767ba75a93db673b017f1f2735e7ea586b72242e6a98495350213d15f7cb804.mp4"}]
  ...
  function buildNodeInfoList(body) {
    ...
    var __v0 = (body["trueFalse"] === undefined || body["trueFalse"] === null) ? "true" : body["trueFalse"]
    setNodeValue(nodes, "538", "value", (__v0 === undefined || __v0 === null) ? "" : String(__v0))
    var __v1 = (body["node571_select"] === undefined || body["node571_select"] === null) ? "1" : body["node571_select"]
    setNodeValue(nodes, "571", "select", (__v1 === undefined || __v1 === null) ? "" : String(__v1))
    var __v2 = (body["node563_select"] === undefined || body["node563_select"] === null) ? "1" : body["node563_select"]
    setNodeValue(nodes, "563", "select", (__v2 === undefined || __v2 === null) ? "" : String(__v2))
    var __v3 = (body["node497_value"] === undefined || body["node497_value"] === null) ? "false" : body["node497_value"]
    setNodeValue(nodes, "497", "value", (__v3 === undefined || __v3 === null) ? "" : String(__v3))
    var __v4 = (body["node297_value"] === undefined || body["node297_value"] === null) ? "1.0000000000000002" : body["node297_value"]
    setNodeValue(nodes, "297", "value", (__v4 === undefined || __v4 === null) ? "" : String(__v4))
    var __v5 = (body["node370_value"] === undefined || body["node370_value"] === null) ? "false" : body["node370_value"]
    setNodeValue(nodes, "370", "value", (__v5 === undefined || __v5 === null) ? "" : String(__v5))
    var __v6 = (body["node361_value"] === undefined || body["node361_value"] === null) ? "1.0000000000000002" : body["node361_value"]
    setNodeValue(nodes, "361", "value", (__v6 === undefined || __v6 === null) ? "" : String(__v6))
    var __v7 = (body["node271_value"] === undefined || body["node271_value"] === null) ? "false" : body["node271_value"]
    setNodeValue(nodes, "271", "value", (__v7 === undefined || __v7 === null) ? "" : String(__v7))
    var __v8 = (body["node265_value"] === undefined || body["node265_value"] === null) ? "0.8000000000000002" : body["node265_value"]
    setNodeValue(nodes, "265", "value", (__v8 === undefined || __v8 === null) ? "" : String(__v8))
    var __v9 = (body["node266_value"] === undefined || body["node266_value"] === null) ? "0.20000000000000004" : body["node266_value"]
    setNodeValue(nodes, "266", "value", (__v9 === undefined || __v9 === null) ? "" : String(__v9))
    var __v10 = (body["node499_value"] === undefined || body["node499_value"] === null) ? "0" : body["node499_value"]
    setNodeValue(nodes, "499", "value", (__v10 === undefined || __v10 === null) ? "" : String(__v10))
    var __v11 = (body["node422_value"] === undefined || body["node422_value"] === null) ? "840" : body["node422_value"]
    setNodeValue(nodes, "422", "value", (__v11 === undefined || __v11 === null) ? "" : String(__v11))
    var __v12 = (body["node264_value"] === undefined || body["node264_value"] === null) ? "30" : body["node264_value"]
    setNodeValue(nodes, "264", "value", (__v12 === undefined || __v12 === null) ? "" : String(__v12))
    var __v13 = (body["node566_select"] === undefined || body["node566_select"] === null) ? "2" : body["node566_select"]
    setNodeValue(nodes, "566", "select", (__v13 === undefined || __v13 === null) ? "" : String(__v13))
    var __v14 = (body["node452_value"] === undefined || body["node452_value"] === null) ? "false" : body["node452_value"]
    setNodeValue(nodes, "452", "value", (__v14 === undefined || __v14 === null) ? "" : String(__v14))
    var __v15 = (body["node451_value"] === undefined || body["node451_value"] === null) ? "9" : body["node451_value"]
    setNodeValue(nodes, "451", "value", (__v15 === undefined || __v15 === null) ? "" : String(__v15))
    var __v16 = (body["node450_value"] === undefined || body["node450_value"] === null) ? "16" : body["node450_value"]
    setNodeValue(nodes, "450", "value", (__v16 === undefined || __v16 === null) ? "" : String(__v16))
    var __v17 = (body["referenceImage"] === undefined || body["referenceImage"] === null) ? "c3cef5cfb224f01d4ca4dce74217bbe78ca8d36963b49292edec293d92343d7a.png" : body["referenceImage"]
    setNodeValue(nodes, "299", "image", (__v17 === undefined || __v17 === null) ? "" : String(__v17))
    var __v18 = (body["referenceVideo"] === undefined || body["referenceVideo"] === null) ? "3767ba75a93db673b017f1f2735e7ea586b72242e6a98495350213d15f7cb804.mp4" : body["referenceVideo"]
    setNodeValue(nodes, "574", "video", (__v18 === undefined || __v18 === null) ? "" : String(__v18))
    return nodes
  }
...
routerAdd("POST", "/api/aigc/ai-app/animatev9/price-preview", function (e) {
  var WEBAPP_ID = "1975951975441412098"
  var NODE_INFO_TEMPLATE = [{"nodeId": "538", "fieldName": "value", "fieldValue": "true"}, {"nodeId": "571", "fieldName": "select", "fieldValue": "1"}, {"nodeId": "563", "fieldName": "select", "fieldValue": "1"}, {"nodeId": "497", "fieldName": "value", "fieldValue": "false"}, {"nodeId": "297", "fieldName": "value", "fieldValue": "1.0000000000000002"}, {"nodeId": "370", "fieldName": "value", "fieldValue": "false"}, {"nodeId": "361", "fieldName": "value", "fieldValue": "1.0000000000000002"}, {"nodeId": "271", "fieldName": "value", "fieldValue": "false"}, {"nodeId": "265", "fieldName": "value", "fieldValue": "0.8000000000000002"}, {"nodeId": "266", "fieldName": "value", "fieldValue": "0.20000000000000004"}, {"nodeId": "499", "fieldName": "value", "fieldValue": "0"}, {"nodeId": "422", "fieldName": "value", "fieldValue": "840"}, {"nodeId": "264", "fieldName": "value", "fieldValue": "30"}, {"nodeId": "566", "fieldName": "select", "fieldValue": "2"}, {"nodeId": "452", "fieldName": "value", "fieldValue": "false"}, {"nodeId": "451", "fieldName": "value", "fieldValue": "9"}, {"nodeId": "450", "fieldName": "value", "fieldValue": "16"}, {"nodeId": "299", "fieldName": "image", "fieldValue": "c3cef5cfb224f01d4ca4dce74217bbe78ca8d36963b49292edec293d92343d7a.png"}, {"nodeId": "574", "fieldName": "video", "fieldValue": "3767ba75a93db673b017f1f2735e7ea586b72242e6a98495350213d15f7cb804.mp4"}]
...
routerAdd("POST", "/api/aigc/ai-app/animatev9/jobs/{jobId}/poll", function (e) {
  var MODEL = "ai-app-animatev9"
...
routerAdd("POST", "/api/aigc/ai-app/animatev9/history", function (e) {
  var MODEL = "ai-app-animatev9"
...
routerAdd("POST", "/api/aigc/ai-app/animatev9/history/{jobId}/update", function (e) {
  var MODEL = "ai-app-animatev9"
...
routerAdd("POST", "/api/aigc/ai-app/animatev9/history/{jobId}/delete", function (e) {
  var MODEL = "ai-app-animatev9"
